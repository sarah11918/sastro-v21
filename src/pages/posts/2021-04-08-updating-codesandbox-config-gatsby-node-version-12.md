...
![CodeSandbox configuration options as a GUI](/images/codesandbox-config-options.jpg)
...
![CodeSandbox configuration options as code](/images/codesandbox-config-code.jpg)
